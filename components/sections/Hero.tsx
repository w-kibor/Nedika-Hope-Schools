...
export function Hero() {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-royal-blue via-[#2b4c9b] to-maroon text-white">
            {/* Abstract Background Elements */}
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -top-20 -left-20 w-96 h-96 bg-gold/10 rounded-full blur-3xl rounded-bl-none"></div>
                <div className="absolute top-40 right-10 w-72 h-72 bg-maroon/30 rounded-full blur-3xl"></div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                >
                    ...
                    <p className="text-lg md:text-2xl text-blue-50 max-w-3xl mx-auto mb-10 font-light">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <Link
                            href="/admissions"
                            className="group bg-gold hover:bg-yellow-400 text-royal-blue px-8 py-4 rounded-full font-bold text-lg transition-all shadow-lg hover:shadow-gold/20 flex items-center"
                        >
                            Apply for 2026
                        ...
                        <Link
                            href="#campus-hub"
                            className="px-8 py-4 rounded-full font-bold text-lg border-2 border-white/20 hover:bg-white/10 transition-all backdrop-blur-sm"
                        >
            ...
            {/* Decorative bottom wave or divider could go here */}
